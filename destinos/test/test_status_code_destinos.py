...
class Test_status_code(APITestCase):
    def setUp(self):
        ...
        self.item1 = {
            'nome': 'Destino de Teste',
            'foto_1': '',
            'foto_2': '',
            'meta_descricao': 'test_descrição',
            'texto_descritivo': '',
        }
        self.destino1 = Destino.objects.create(
            nome='Destino 2',
            foto_1='',
            foto_2='',
            meta_descricao='descrição',
            texto_descritivo='test',
        )
        self.destino2 = Destino.objects.create(
            nome='Destino 3',
            foto_1='',
            foto_2='',
            meta_descricao='descrição',
