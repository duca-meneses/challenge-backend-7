...
class TestStatusCode(APITestCase):
    def setUp(self):
        ...
        self.item1 = {'nome': 'Depoimento de Teste', 'depoimento': 'Conteúdo do depoimento de teste'}
        self.depoimento1 = Depoimentos.objects.create(nome='Depoimento 2', depoimento='Conteúdo do depoimento 2')
        self.depoimento2 = Depoimentos.objects.create(nome='Depoimento 3', depoimento='Conteúdo do depoimento 3')
        self.depoimento3 = Depoimentos.objects.create(nome='Depoimento 4', depoimento='Conteúdo do depoimento 4')
        self.depoimento4 = Depoimentos.objects.create(nome='Depoimento 5', depoimento='Conteúdo do depoimento 5')
