...
class TestStatusCode(APITestCase):
    def setUp(self):
        ...
        self.depoimento1 = Depoimento.objects.create(nome='Depoimento 2', depoimento='Conteúdo do depoimento 2')
        self.depoimento2 = Depoimento.objects.create(nome='Depoimento 3', depoimento='Conteúdo do depoimento 3')
        self.depoimento3 = Depoimento.objects.create(nome='Depoimento 4', depoimento='Conteúdo do depoimento 4')
